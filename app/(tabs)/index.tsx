        ...
        <View style={styles.popupOverlay}>
          <View style={styles.popupCard}>
            <View
              style={[
                styles.iconCircle,
                popup.type === "danger" ? styles.bgDanger : styles.bgSuccess,
              ]}
            >
              <MaterialIcons
                name={
                  popup.type === "danger" ? "delete-forever" : "check-circle"
                }
                size={32}
                color="#fff"
              />
      ...
      >
        ...
        >
          <Pressable style={styles.modalCard} onPress={() => {}}>
            ...
            <Text style={{ color: "#5A6472", marginBottom: 20 }}>
...
const styles = StyleSheet.create({
  ...
  // ✅ NEW CENTRALIZED POPUP STYLES
  popupOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: "rgba(0, 0, 0, 0.2)", // Dimmed backdrop background
    justifyContent: "center",
    alignItems: "center",
    zIndex: 9999,
    elevation: 10,
